...
// File contracts/farm/BeraStakingPoolInitializable.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.0;

contract BeraStakingPoolInitializable is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    // The address of the smart chef factory
    address public immutable SOUS_CHEF_FACTORY;
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        if (hasUserLimit) {
            require((_amount + user.amount) <= poolLimitPerUser, "Deposit: Amount above limit");
        }
    ...
    function recoverWrongTokens(address _token) external onlyOwner {
        ...
        emit AdminTokenRecovery(_token, balance);
    }
