...
const testDexFarmAddress = "0xF7Bf446DB1D51D51131BFae68A93467b928719c6"; //contract Farm
const lpTokenAddress = "0x2E0a170625cfEd2f4586d7AbcDA7481e79D3415A"; //contract Pair
...
async function main() {
  ...
  while (totalPools.toNumber() < 2) {
    ...
    let tx = await testDexFarm.add(2, lpTokenAddress, false, true, {
      gasLimit: 500000,
...
// npx hardhat run test/AddTestFarm.js --network MonadChain 