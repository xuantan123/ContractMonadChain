...
async function CheckSwap() {
    ...
    try {
        ...
        // Thực hiện swap
        const tx = await routerContract.getUserSwapCount(userAddress);
        console.log(`✅ Số lần swap của người dùng ${userAddress}: ${tx.toString()}`);
    } catch (error) {
        console.error("❌ Lỗi khi Checkswap:", error);
    }
}
...
// npx hardhat run test/MintNFTs/CheckSwap.js --network MonadChain