...
const testDEX = "0xf7E259629aFC7A1739C306D48B7Aee32b805A0dd"; //Token TTT
...
async function main() {
  ...
  let tx = await ZTWToken.approve(testDEXStakeAddress, amount);
  await tx.wait();
  ...
  // const maxFeePerGas = feeData.maxFeePerGas ? feeData.maxFeePerGas.mul(2) : ethers.utils.parseUnits("20", "gwei");
  // const maxPriorityFeePerGas = feeData.maxPriorityFeePerGas ? feeData.maxPriorityFeePerGas.mul(2) : ethers.utils.parseUnits("2", "gwei");

  tx = await testDEXStake.deposit(
    amount,
    lockDuration
    // {
    //   gasLimit: 1000000,
  ...
  console.log("🔍 Current lockedAmount:", ethers.utils.formatUnits(userInfo.lockedAmount, 18));
  console.log("🔍 Current shares:", ethers.utils.formatUnits(userInfo.shares, 18));
}
...
// npx hardhat run test/TestDEXStake/TestDexStake.deposit.js --network MonadChain